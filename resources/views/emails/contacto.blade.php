    ...
    <tbody>
        ...
        <td align='left' bgcolor='#ffffff' style='text-align:center;'>
            <table width='700' height='300' bgcolor='#000' cellpadding='0' cellspacing='0'>
                <tbody>
                <tr height='100'><td bgcolor='#4DC8E9' style='color:#FFFFFF;font-size:large' colspan='3'>Blue Terrier</td></tr>
                <tr height='400'>
                    <td bgcolor='#fff' style='border-left:1px solid #4DC8E9;border-right:1px solid #4DC8E9;'>
                    <table style='font-family:sans-serif, Arial, Helvetica'>
                        ...
                        <td style='text-align:left'>
                            ...
                            <p><b>Teléfono:</b>  {{ Input::get('m') }} </p>
                            <p><b>Comentario:</b>  {{ Input::get('c') }} </p>
                            <p><a style='color:#3a6f8f;text-decoration:none;' href='http://blueterrier.com' target='_blank'><span style='text-transform:uppercase;'></span><br>Blue Terrier</a></p>
                        </td>
                        <td width='10'></td>
                        </tr>
                        </tbody>
